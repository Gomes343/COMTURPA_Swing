 ...
 * @author Oscar
 */
public class PAView extends javax.swing.JFrame {
    ...
    public PAView() throws IOException, SQLException {
        dao = new DAOPA();
  ...
  worker.execute();
    ...
    private void initComponents() {
        ...
        jLabel7.setText("PROCESSO ADMINISTRATIVO");
    ...
    private void TextAreaMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_TextAreaMouseClicked
        ...
        try {
            ...
            Logger.getLogger(PAView.class.getName()).log(Level.SEVERE, null, ex);
        }
    ...
    private void ButtonAlterarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_ButtonAlterarActionPerformed
        ...
        ProcessoAdministrativo a = new ProcessoAdministrativo();
        a.setData(FieldData.getText());
        a.setNumero(FieldNumero.getText());
        a.setCriador(FieldCriador.getText());
        a.setObjeto(FieldObjeto.getText());
        a.setStatus(FieldStatus.getText());
        a.setObservacao(FieldObs.getText());
        
        if(clicked == true){
            AlterarPAView acv = new AlterarPAView(a,this);
    ...
    public static void main(String args[]) throws IOException, SQLException {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(PAView.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
